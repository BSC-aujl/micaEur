...
describe("MiCA EUR Functional Tests", () => {
  ...
  describe("Token Functionality Tests", () => {
    it("should initialize mint info", () => {
      ...
      expect(storedFreezeAuthority.equals(freezeAuthority.publicKey)).to.be.true;
    ...
    it("should transfer tokens between accounts", () => {
      ...
      expect(user1Decoded.amount.toString()).to.equal((initialUser1Amount - transferAmount).toString());
      expect(user2Decoded.amount.toString()).to.equal(transferAmount.toString());
    });
  });
  ...
  describe("AML Authority Tests", () => {
    it("should register an AML authority", () => {
      ...
      accountData[100] = (1 << AML_POWERS.VIEW_TRANSACTIONS) | (1 << AML_POWERS.FREEZE_ACCOUNTS);
  ...
  describe("Freeze/Seize Functionality Tests", () => {
    ...
    it("should seize tokens from a frozen account", () => {
      ...
      expect(user1Decoded.amount.toString()).to.equal((1000_000_000_000n - seizeAmount).toString());
