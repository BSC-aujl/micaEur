...
const PROGRAM_ID =
  process.env.PROGRAM_ID || "FqyFQg8TEaxKNGd5LqHRMBKfNVQHeiohorXRiu2dATZX";
...
app.post("/payment/sepa-transfer", async (req, res) => {
  ...
  const transferResult = await MockBankingAPI.checkSEPATransfer(
    reference,
    amount
  );
